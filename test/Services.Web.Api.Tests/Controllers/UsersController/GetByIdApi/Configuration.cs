...
namespace Template.Services.Web.Api.Tests.Controllers.UsersController.GetByIdApi
{
    public class Configuration : BaseConfiguration
    {
        ...
        public async Task<HttpResponseMessage> WhenRequestingTheGetUserByIdApiAsync(string userId = "")
        {
            return await RequestingApiAsync(new HttpMethod("GET"), $"/v1/users/{userId}");
        }
        ...
        public async Task<string> GivenAValidUserId()
        {
            ...
            user.Email = "getbyidapi@domain.com";
